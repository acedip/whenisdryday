...
<html>
    <head>
        ...
        <meta property="og:title" content="Whenisdryday Success" />
        
        <title>Whenisdryday Success</title>
		<style type="text/css">
			...
			*/
			#templateHeader{
				/*@editable*/ background-color:#65635A;
			...
			*/
			#templateContainer, .bodyContent{
				/*@editable*/ background-color:#FFF6E1;
			}
			...
			*/
			#templateFooter{
				/*@editable*/ background-color:#817E73;
                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
                        	<tr>
                            	<td align="center" valign="top">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="50" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            <div mc:edit="tiwc200_content00">
                                            	<strong>When is Dry Day?</strong>
                                            </div>
                                            	...
                                            	<table border="0" cellpadding="0" cellspacing="0" width="400">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top">
 						                                                            <div mc:edit="std_content00">
						                                                                ...
						                                                                <h4 class="h4">Hi {{dUserInfo['first_name']}} {{dUserInfo['last_name']}}</h4>
						                                                                <strong>Cheers !!</strong> You received this email because you signed up for whenisdryday.in
						                                                            </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                			...
                                                                			<tr>
                                                                				<td valign="middle" class="templateButtonContent">
                                                                					<div mc:edit="std_content01">
                                                                						<a href="http://www.mandrill.com/" target="_blank">Click to Confirm subscription</a>
                                                                					</div>
                                                                				</td>
                                                                			</tr>
                                                                		</table>
                                                    ...
                                                    <tr>
                                                    	<td valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0" width="400">
                                                            	<tr>
	                                                            	<td valign="top" width="340" class="leftColumnContent">
                                                                            ...
                                                                            <tr mc:repeatable>
                                                                                <td valign="top">
                                                                                    <div mc:edit="tiwc200_content01">
			                                                                            <strong>Don't be afraid !!</strong> We are here to save you from dry days.
                                                                                    </div>
                                                                                    <img src="./dryday-email1.jpg" style="max-width:340px; margin-bottom:10px;" mc:label="image" mc:edit="tiwc200_image02" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                <!-- // Begin Module: dry day tabular heading \\ -->
                                                                    <td valign="top" width="180" class="rightColumnContent">
                                                                        <!-- // Begin Module: dry day tabular content \\ -->
                                                                        <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                            <tr mc:repeatable>
                                                                                <td valign="top">
                                                                                    <div mc:edit="tiwc200_content02">
			                                                                            <h4 class="h4">Dry days in < YOUR STATE > </h4>
			                                                                            Here is the list off dry days in < YOUR STATE >		
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>                
                                                                ...
                                                                <tr>
	                                                                ...
	                                                                <td valign="top" width="180" class="rightColumnContent">
                                                                        <table border="0" cellpadding="15" cellspacing="0" width="300">
                                                                        	<!-- DRY DAYS TABLE WILL GO HERE -->
                                                                            <tr>
                                                                                <td> <strong> Dry Date </strong> </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td> date 3 </td>
                                                                                <td> reason 3 </td>
                                                                            </tr> <!-- This is an empty cell -->
                                                                            	<td>  </td>
                                                                                <td>  </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // End Module: dry day with tabular Content \\ -->                  
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                	...
                                                	<tr>
                                                    	<td valign="top" class="sidebarContent">
                                                                            ...
                                                                            <tr mc:hideable>
                                                                                ...
                                                                                <td align="left" valign="top">
                                                                                    <div mc:edit="sbwi_link_one">
                                                                                        <a href="*|FACEBOOK:PROFILEURL|*">Like on Facebook</a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr mc:hideable>
                                                            ...
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top">
                                                                        <img src="file:///C:/Users/ashekhawat/Documents/GitHub/whenisdryday/mail/Drink-Smoke-and-Fly.jpg" style="max-width:160px; margin-bottom:10px;" mc:edit="tiwc200_image00" />
                                                                        <div mc:edit="tiwc200_content00">
                                                                            <strong>Don't Drink and Drive !!</strong>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr mc:repeatable>
                                                                    <td valign="top">
                                                                        <img src="file:///C:/Users/ashekhawat/Documents/GitHub/whenisdryday/mail/durnkfuck.jpg" style="max-width:160px; margin-bottom:10px;" mc:edit="tiwc200_image00" />
                                                                        <div mc:edit="tiwc200_content00">
                                                                            <strong>Real Men Don't Rape</strong> 
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="350">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2013 | Whenisdryday | All rights reserved.</em>
																<br />
																<strong>Email Us:</strong> beer@whenisdryday.in
                                                            </div>
                                                        </td>
                                                        <td valign="top" width="190" id="monkeyRewards">
                                                            <div mc:edit="monkeyrewards">
																It's an open source project - <a href="github.com/acedip/whenisdryday">Checkout Our Code</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" valign="middle" id="utility">
                                                            <div mc:edit="std_utility">
                                                                &nbsp;<a href="*|UNSUB|*">Unsubscribe</a> | <a href="*|UPDATE_PROFILE|*">update subscription preferences</a>&nbsp;
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
